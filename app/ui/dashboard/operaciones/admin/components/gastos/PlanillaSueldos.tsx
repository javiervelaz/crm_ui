...
export default function PlanillaSueldos({ data = [], onUpdate, categorias = [] }: Props) {
  ...
  return (
    <div>
      <h2 className="mb-4 text-lg font-bold text-brand-800">Sueldos</h2>
        ...
        <table className="w-full border-collapse rounded-lg overflow-hidden text-sm">
          <thead>
            <tr className="bg-brand-50">
              <th className="px-4 py-2 text-left text-xs font-semibold text-brand-600 uppercase tracking-wider border-b border-brand-100">Empleado</th>
