...
import { DollarSign, FileText, Home, LogOut, Package, Shield } from "lucide-react";
...
const MenuEmpleado = () => {
  ...
  return (
    <aside className="w-64 bg-white shadow-xl  p-6">
      <h2 className="text-lg font-semibold text-gray-700 mb-6">Panel Empleado</h2>
        ...
        {roles.includes(1) && (
          <li>
            <a
              ...
              className="flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white  shadow hover:scale-105 hover:shadow-lg transition"
            >
              <Shield size={18} /> Dashboard administrador
            </a>
          </li>
        )}
        <li>
          ...
          >
            <Home size={18} /> Dashboard Empleados
          </a>
        </li>
        <li>
          <a
