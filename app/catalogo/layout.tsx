...
import {
  ...
  useHandoffSession,
} from './HandoffSessionContext';

function CatalogLayoutInner({ children }: { children: ReactNode }) {
  ...
  // 3) Token válido → render normal del micrositio
  return (
    <CartProvider>
...
// Wrapper que provee el contexto a todo lo de arriba
export default function CatalogLayout({ children }: { children: ReactNode }) {
  return (
    <HandoffSessionProvider>
      <CatalogLayoutInner>{children}</CatalogLayoutInner>
    </HandoffSessionProvider>
  );
}
